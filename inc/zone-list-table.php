...
class Zone_List_Table extends WP_List_Table {
    ...
    function extra_tablenav( $which ) {
        if ( $which == "top" ){
            ...
            echo"<span style='line-height:32px;'></span>";
        }
        if ( $which == "bottom" ){
        ...
        switch($column_name){
            case 'status':
                ...
                if ($item['zone_enabled'] == '1')
                    $return_image .=  '<img src="' . plugins_url( '/success.png', __FILE__ ) . '" alt="yes" />';
                else
                    $return_image .=  '<img src="' . plugins_url( '/success-off.png', __FILE__ ) . '" alt="no" />';
    ...
    function column_title($item){
        ...
        //Build row actions
        $actions = array(
            'edit'      => sprintf('<a href="?page=%s&tab=fee-regions&action=%s&zone=%s">Edit</a>',$_REQUEST['page'],'edit',$item['zone_id']),
            'delete'    => sprintf('<a href="?page=%s&tab=fee-regions&action=%s&zone=%s">Delete</a>',$_REQUEST['page'],'delete',$item['zone_id']),
        );
    ...
    static function tt_render_list_page(){
        ...
        <div class="wrap woocommerce">
            ...
            <h2>Fee Regions <a href="?page=<?php echo $_REQUEST['page']; ?>&tab=fee-regions&action=new" class="add-new-h2">Add New</a></h2>
            </form>
...
?>
    ...
    <?php 
        ...
        if($method == 'edit' ) : 
            ...
            if( is_array( $shipping_zones ) && count( $shipping_zones ) > 0) {
    ...
    ?>
            ...
            <div id="icon-users" class="icon32"><br/></div>
            <h2><?php if($method == 'edit') : ?>Edit<?php else : ?>Add<?php endif;?> Shipping Zone <a href="?page=<?php echo $_REQUEST['page']; ?>&tab=fee-regions&action=new" class="add-new-h2">Add New</a></h2>
